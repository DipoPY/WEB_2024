...
class Book(db.Model):
    ...
    image_id = db.Column(db.String(100), db.ForeignKey('images.id', ondelete="SET NULL"))
    genres = db.relationship('Genre', secondary=book_genre, backref=db.backref('books', lazy='dynamic'), cascade="all,delete")
    image = db.relationship('Image', backref=db.backref('books', lazy='dynamic'), cascade="all,delete")
...
class Comment(db.Model):
    ...
    user = db.relationship('User', backref=db.backref('comments', lazy='dynamic', cascade="all,delete"))
    book = db.relationship('Book', backref=db.backref('comments', lazy='dynamic', cascade="all,delete"))
